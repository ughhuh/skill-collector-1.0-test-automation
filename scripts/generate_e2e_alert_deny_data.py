...
data_2 = {
    '*** Test Cases ***': ['Too Many Hard Skills', 'Too Many Soft Skills'],
    '${hash}': ['0123456789', '0123456789'],
    'e{skills_1}': [[x + "-1" for x in hard_skill_rand_4[:6]],[x + "-1" for x in soft_skill_rand_4[:2]]],
    'e{skills_2}': [[x + "-2" for x in hard_skill_rand_4[6:12]],[x + "-2" for x in soft_skill_rand_4[2:4]]],
    'e{skills_3}': [[x + "-3" for x in hard_skill_rand_4[12:18]],[x + "-3" for x in soft_skill_rand_4[4:6]]],
    'e{skills_4}': [[x + "-4" for x in hard_skill_rand_4[18:]],[]],
    'e{categories}': [['Future need', 'Valuable', 'Important', 'Most Important'],['Valuable', 'Important', 'Very Important']],
    '${number}': ['5','1'],
    '${setup}': ['Access Hard Skills','Access Soft Skills'],
    '[Tags]': ['Functional,Regression,FEA21','Functional,Regression,FEA29']
}
...
data_3 = {
    ...
    '${message}': ['You have not selected enough SFIA skills. Please select 20 skills.','You have not selected enough soft skills. Please select 3 soft skills.','You have not selected enough skills. Please select 20 skills and 3 soft skills.'],
    '[Tags]':['Functional,Regression,FEA21', 'Functional,Regression,FEA29', 'Functional,Regression,FEA21,FEA29']
}
